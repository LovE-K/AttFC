...
MODEL = os.path.join(r'~\share\megaface\devkit', 'models', 'jb_identity.bin')
IDENTIFICATION_EXE = os.path.join(r'~\share\megaface\devkit', 'bin', 'Identification')
FUSE_RESULTS_EXE = os.path.join(r'~\share\megaface\devkit', 'bin', 'FuseResults')
MEGAFACE_LIST_BASENAME = os.path.join(r'E~\share\megaface\devkit', 'templatelists', 'megaface_features_list.json')
PROBE_LIST_BASENAME = os.path.join(r'~\share\megaface\devkit', 'templatelists', 'facescrub_features_list.json')
...
def main():
    ...
    distractor_feature_path = "/share/megaface/data/feature_out_clean/megaface"
    out_root = r"~\share\megaface\out"
    probe_feature_path = r"~\share\megaface\data\feature_out_clean\facescrub"
    model = args.model
    num_sets = args.num_sets
    sizes = args.sizes
    file_ending = "_insightface.bin"
