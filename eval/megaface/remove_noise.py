...
def parse_arguments(argv):
    ...
    parser.add_argument('--facescrub-noises',
                        type=str,
                        help='',
                        default=r'E:\DATASET\megaface\data\facescrub_noises.txt')
    parser.add_argument('--megaface-noises',
                        type=str,
                        help='',
                        default=r'E:\DATASET\megaface\data\megaface_noises.txt')
    ...
    parser.add_argument('--feature-dir-input',
                        type=str,
                        help='',
                        default=r'E:\DATASET\megaface\data\feature_out')
    parser.add_argument('--feature-dir-out',
                        type=str,
                        help='',
                        default=r'E:\DATASET\megaface\data\feature_out_clean')
