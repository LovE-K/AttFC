...
class Sampler(Dataset):
    def __init__(self, datasets, p_datasets, sampling_base, k, random_idx=False):
        """
    ...
    def __getitem__(self, index):
        ...
        return images, np.array([float(seq_id + start_idx)], dtype=np.float32)
